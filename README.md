# genpark-conversational-recruiter-notetaker-competency-scorer-skill
...
> **GenPark AI Agent Skill** -- Conversational recruiter notetaker & candidate competency matrix scorer (Candit style)
